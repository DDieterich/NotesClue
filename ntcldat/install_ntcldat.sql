...
@dbi.sql "CLUE/CARDS_ACT.cdl" "CLUE" "&INSTALL_SYSTEM_CONNECT."
@dbi.sql "CLUE/CARD_TYPES_ACT.cdl" "CLUE" "&INSTALL_SYSTEM_CONNECT."
@dbi.sql "CLUE/GAMES_ACT.cdl" "CLUE" "&INSTALL_SYSTEM_CONNECT."
@dbi.sql "CLUE/PLAYERS_ACT.cdl" "CLUE" "&INSTALL_SYSTEM_CONNECT."
@dbi.sql "CLUE/USERS_ACT.cdl" "CLUE" "&INSTALL_SYSTEM_CONNECT."
