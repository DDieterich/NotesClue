...
@"../grb_linked_install_scripts/summarize_install_log.sql" "ntcldat" "" ""
...
@"../grb_linked_install_scripts/list_invalids.sql" "'CLUE'" "" ""
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/db_build_junit_report.sql" "'CLUE'" "" ""
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/log_files_junit_report.sql" "ntcldat" "" ""
spool off
set termout on
set feedback on
