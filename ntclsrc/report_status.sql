...
@"odbcapture_installation_logs.cdl" "&1."
...
@"../grb_linked_install_scripts/summarize_install_log.sql" "ntclsrc" "" ""
...
@"../grb_linked_install_scripts/list_invalids.sql" "'CLUE','DMSTEX'" "" ""
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/db_build_junit_report.sql" "'CLUE','DMSTEX'" "" ""
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/log_files_junit_report.sql" "ntclsrc" "" ""
spool off
set termout on
set feedback on
