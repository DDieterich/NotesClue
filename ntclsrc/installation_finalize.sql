...
prompt
prompt compile_all
@"../grb_linked_install_scripts/compile_all.sql" "'CLUE','DMSTEX'" "" ""

prompt
prompt alter_foreign_keys_ENABLE
@"../grb_linked_install_scripts/alter_foreign_keys.sql" "ENABLE" "'CLUE','DMSTEX'" ""

prompt
prompt alter_triggers_ENABLE
@"../grb_linked_install_scripts/alter_triggers.sql" "ENABLE" "'CLUE','DMSTEX'" ""

prompt
prompt update_id_sequences
@"../grb_linked_install_scripts/update_id_sequences.sql" "'CLUE','DMSTEX'" "" ""

--prompt
--prompt alter_queues_ENABLE
--@"../grb_linked_install_scripts/alter_queues.sql" "ENABLE" "'CLUE','DMSTEX'" ""

--prompt
--prompt alter_scheduler_jobs_ENABLE
--@"../grb_linked_install_scripts/alter_scheduler_jobs.sql" "ENABLE" "'CLUE','DMSTEX'" ""
