...
prompt  APPLICATION 100 - DMSTEX
--
-- Application Export:
--   Application:     100
--   Name:            DMSTEX
--   Date and Time:   05:59 Saturday October 12, 2013
--   Exported By:     DMSTEX
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,6238600227078768));
...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'DMSTEX'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F100'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 12225621697191389 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 12225827026191389 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 12228929853191392 + wwv_flow_api.g_id_offset,
  p_error_template=> 12225208510191388 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20131012055840',
  ...
  p_cust_authentication_process=> '.'||to_char(12234534285191398 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 21,
  p_default_label_template => 12233232186191397 + wwv_flow_api.g_id_offset,
  p_default_report_template => 12232503583191397 + wwv_flow_api.g_id_offset,
  p_default_list_template => 12231528044191396 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 12233527925191397 + wwv_flow_api.g_id_offset,
  p_default_button_template => 12226305569191391 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 12227913347191392 + wwv_flow_api.g_id_offset,
  p_default_form_template => 12228003589191392 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 12229832677191393 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 12228929853191392 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>12228929853191392 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 12227420212191391 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 12227810374191391 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 12228531863191392 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'DMSTEX',
  p_last_upd_yyyymmddhh24miss=> '20131012055840',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 12234820449191398 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 12328712089957865 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_tab (
  p_id=> 12236226246191409 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'Welcome to the Home Page for the Data Maintenance Forms.<br>'||chr(10)||
'<br>'||chr(10)||
'Click on the Navigation List below. Use the Breadcrumbs above to return Home.<br>';

wwv_flow_api.create_page_plug (
  p_id=> 12236310363191410 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Home',
  p_region_name=>'',
  p_plug_template=> 12228929853191392+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 12236533757191410 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 12227420212191391+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(12235933913191408 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 12233527925191397+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_plug (
  p_id=> 12328510704957444 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Utility Menu',
  p_region_name=>'',
  p_plug_template=> 12227810374191391+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 20,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
  p_plug_source_type=> 12311011194825704 + wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 12224826232191388 + wwv_flow_api.g_id_offset
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 12235107180191402 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
  p_plug_template=> 12228003589191392+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_page_item(
  p_id=>12235206592191404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 12235107180191402+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 12233232186191397+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'N',
  p_attribute_02 => 'N',
  p_attribute_03 => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>12235319126191407 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>12235420189191407 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(12226305569191391 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 12235613752191408 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 12235522266191407 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 12235807425191408 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 12235705727191408 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 12311011194825704 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Utility Menu',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 12230028788191393 + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_menu (
  p_id=> 12235933913191408 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>12236430900191410 + wwv_flow_api.g_id_offset,
  p_menu_id=>12235933913191408 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
prompt  ......Page template 12224826232191388
...
wwv_flow_api.create_template(
  p_id=> 12224826232191388 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 12224922813191388
...
wwv_flow_api.create_template(
  p_id=> 12224922813191388 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225017720191388
...
wwv_flow_api.create_template(
  p_id=> 12225017720191388 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225132630191388
...
wwv_flow_api.create_template(
  p_id=> 12225132630191388 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225208510191388
...
wwv_flow_api.create_template(
  p_id=> 12225208510191388 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225324472191388
...
wwv_flow_api.create_template(
  p_id=> 12225324472191388 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225408866191388
...
wwv_flow_api.create_template(
  p_id=> 12225408866191388 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225528464191389
...
wwv_flow_api.create_template(
  p_id=> 12225528464191389 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225621697191389
...
wwv_flow_api.create_template(
  p_id=> 12225621697191389 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225730019191389
...
wwv_flow_api.create_template(
  p_id=> 12225730019191389 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 12225827026191389
...
wwv_flow_api.create_template(
  p_id=> 12225827026191389 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12225934125191389
...
wwv_flow_api.create_template(
  p_id=> 12225934125191389 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12226002572191389
...
wwv_flow_api.create_template(
  p_id=> 12226002572191389 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12226105555191389
...
wwv_flow_api.create_template(
  p_id=> 12226105555191389 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 12226228151191391
...
wwv_flow_api.create_template(
  p_id=> 12226228151191391 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 12226305569191391
declare
...
wwv_flow_api.create_button_templates (
  p_id=>12226305569191391 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 12226402759191391
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>12226402759191391 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 12226519899191391
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>12226519899191391 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 12226621582191391
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>12226621582191391 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 12226718343191391
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>12226718343191391 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 12226807018191391
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>12226807018191391 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 12226904562191391
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>12226904562191391 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 12227024061191391
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 12227024061191391 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 12227127724191391
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 12227127724191391 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 